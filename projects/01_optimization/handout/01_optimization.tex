...
\textbf{Issue Date} : \today (originally posted on February 19, 2020)

\textbf{Teaching Assistant} : Tejaswin Parthasarathy, \texttt{tp5@illinois.edu}

\textbf{Submission Date/Time}: Wednesday 11:59 PM, 11 March, 2020
...
\label{sec:org26e3e46}
\subsection{Definition}
\label{sec:org3ea49c7}
...
\label{sec:org3c17a57}
\subsection{Definition}
\label{sec:orgbaa36cf}
