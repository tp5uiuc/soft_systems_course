...
\label{sec:orgd3fbedb}
\subsection{Definition}
\label{sec:org28c8544}
...
The rotated hyper-ellipsoid in two dimensions, the horizontal axis corresponds to \(x_1\) and the vertical to \(x_2\)}
\end{figure}
...
\label{sec:orga5188da}
\subsection{Definition}
\label{sec:org6b5e753}
