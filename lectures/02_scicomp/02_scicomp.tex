...
\section{\texttt{numpy}}
\label{sec:org5dd5662}
\begin{frame}[label={sec:org315c365},fragile]{\texttt{numpy} package \footnote{\href{https://www.numpy.org/}{numpy}}}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0294f26},fragile]{Simple array creation in \texttt{numpy}}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org17d19f2},fragile]{Array generating functions}
 \note{:B\_note:
\begin{itemize}
\item Show as a demonstration\ldots{}
\end{itemize}}
...
\begin{frame}[label={sec:org67c44be},fragile]{Random numbers}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb294c00},fragile]{Indexing}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:orgd280255},fragile]{Linear Algebra}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:org0740199},fragile]{Practice}
...
\label{sec:orgd569fa2}
\begin{frame}[label={sec:orgd890a4c}]{Schematic}
\footnotesize
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orga97ddbf}]{Let's use GA to solve\ldots{}}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org29fba91},fragile]{Representation?}
...
\end{frame}
\begin{frame}[label={sec:org276ba68},fragile]{GA parameters}
...
\begin{frame}[label={sec:org7373643}]{Fitness assignment}
...
\end{frame}
\begin{frame}[label={sec:org935a813},fragile]{Selection (for variation)}
...
\end{frame}
\begin{frame}[label={sec:orgd6bda2a},fragile]{Variation}
...
\end{frame}
\begin{frame}[label={sec:org872e6c1},fragile]{Variation}
...
\end{frame}
\begin{frame}[label={sec:orgf47d69e}]{Selection (environmental)}
...
\end{frame}
\begin{frame}[label={sec:orgbb17763}]{Putting it all together}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org94c75af}]{Practice}
