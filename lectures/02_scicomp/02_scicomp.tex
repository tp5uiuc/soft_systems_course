...
\section{\texttt{numpy}}
\label{sec:orgf5e0fe9}
\begin{frame}[label={sec:org4357d5c},fragile]{\texttt{numpy} package \footnote{\href{https://www.numpy.org/}{numpy}}}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0183416},fragile]{Simple array creation in \texttt{numpy}}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8d3ccc5},fragile]{Array generating functions}
 \note{:B\_note:
\begin{itemize}
\item Show as a demonstration\ldots{}
\end{itemize}}
...
\begin{frame}[label={sec:org97fa7d7},fragile]{Random numbers}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orge6b00ea},fragile]{Indexing}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:org717eb4a},fragile]{Linear Algebra}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:org94e018f},fragile]{Practice}
...
\label{sec:org79adcd2}
\begin{frame}[label={sec:orgd09d65b}]{Schematic}
\footnotesize
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org48f37ff}]{Let's use GA to solve\ldots{}}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orged072f5},fragile]{Representation?}
...
\end{frame}
\begin{frame}[label={sec:org13f58dc},fragile]{GA parameters}
...
\begin{frame}[label={sec:org273c85b}]{Fitness assignment}
...
\end{frame}
\begin{frame}[label={sec:org28bd57d},fragile]{Selection (for variation)}
...
\end{frame}
\begin{frame}[label={sec:org1d63761},fragile]{Variation}
...
\end{frame}
\begin{frame}[label={sec:org52eaf92},fragile]{Variation}
...
\end{frame}
\begin{frame}[label={sec:org24ccfeb}]{Selection (environmental)}
...
\end{frame}
\begin{frame}[label={sec:orgd63642d}]{Putting it all together}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org08ad810}]{Practice}
