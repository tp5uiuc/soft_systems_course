...
\begin{frame}[label={sec:orga9af4ae}]{Logistics}
\begin{itemize}
\item Office hours
...
\label{sec:org741b325}
\begin{frame}[label={sec:org987f494}]{Last class}
\begin{columns}
...
\begin{frame}[label={sec:orgaa86498},fragile]{Content}
 \begin{itemize}
...
\begin{frame}[label={sec:org5ca77f1},fragile]{Quick survey}
 \begin{itemize}
\item \texttt{Python}?
...
\end{frame}
\section{Why python?}
\label{sec:orgcae01ae}
\begin{frame}[label={sec:org8a3f32c}]{Python is popular \footnote{Slide credits: \href{https://github.com/williamgrimes/teach\_python\_in\_notebooks/blob/master/python\_course.pdf}{William Grimes @ Github}}}
\begin{columns}
...
\begin{frame}[label={sec:org83d19cc}]{Python as a language}
\begin{itemize}
...
\begin{frame}[label={sec:org2031f2f},fragile]{Interactive\footnote{\href{https://wiki.python.org/moin/IntegratingPythonWithOtherLanguages}{Wiki Python}}}
 \begin{itemize}
...
\begin{frame}[label={sec:orgcb9b24c}]{FlappyBird      \footnote{\href{https://yanpanlau.github.io/2016/07/10/FlappyBird-Keras.html}{ FlappyBird-Keras}, \href{https://github.com/yanpanlau/Keras-FlappyBird/blob/master/qlearn.py}{Code} , \href{https://www.pygame.org/wiki/about}{Pygame}, \href{https://scikit-image.org/}{Scikit-image}, \href{https://www.tensorflow.org/}{TensorFlow}}}
\begin{columns}
...
\begin{frame}[label={sec:org9446a12},fragile]{Comp. modeling with HPC using FOSS packages}
...
\begin{frame}[label={sec:org343f730}]{Your favorite applications use Python!}
\begin{itemize}
\item Dropbox
\item Spotify
\item Email clients
...
\begin{frame}[label={sec:orgf5a5a8d},fragile]{We will use python for\footnote{\href{https://zulko.github.io/blog/2014/11/13/things-you-can-do-with-python-and-pov-ray/\#disqus\_thread}{Vapory/Povray}}\textsuperscript{,}\,\footnote{\href{http://mattia-lab.com/work/soft-filaments/}{Mattialab}}}
 \begin{itemize}
...
\label{sec:org9a891fc}
\begin{frame}[label={sec:orga12d4c1}]{Shell?}
\begin{itemize}
...
\begin{frame}[label={sec:orgc877b57},fragile]{On to your shell}
 \begin{itemize}
...
\begin{frame}[label={sec:orgd724f82},fragile]{Shell demo}
...
\begin{frame}[label={sec:org8424924},fragile]{View current directory}
 \begin{block}{Command}
\begin{minted}[]{shell}
...
\begin{frame}[label={sec:orgaf78302},fragile]{My current directory structure?}
 \begin{block}{Command}
\begin{minted}[]{fish}
...
\begin{frame}[label={sec:org8c911cb},fragile]{What's my current directory?}
 \begin{block}{Command}
\begin{minted}[]{shell}
...
\begin{frame}[label={sec:org2d1f364},fragile]{Navigate to another directory}
 \begin{block}{Command}
\begin{minted}[]{shell}
...
\begin{frame}[label={sec:orgea870d0},fragile]{Navigate back to source directory}
 \begin{block}{Command}
\begin{minted}[]{shell}
cd images # Change Directory
...
\begin{frame}[label={sec:orgfbc9a58},fragile]{Make a new directory}
 \begin{block}{Command}
\begin{minted}[]{shell}
...
\begin{frame}[label={sec:org74eeca3},fragile]{Remove directories and files}
 \begin{block}{Command}
\begin{minted}[]{shell}
...
\begin{frame}[label={sec:orgb331988},fragile]{If the directory has files, then}
 \begin{block}{Command}
\begin{minted}[]{bash}
mkdir MyFolderName
...
\begin{frame}[label={sec:orgcf97295},fragile]{See file contents}
 \begin{block}{Command}
\begin{minted}[]{sh}
...
\begin{frame}[label={sec:org6c4c1de},fragile]{Move files around}
 \begin{block}{Command}
\begin{minted}[]{sh}
...
\begin{frame}[label={sec:orgc7ec7e9},fragile]{Copy files around}
 \begin{block}{Command}
\begin{minted}[]{sh}
...
\begin{frame}[label={sec:orgc172d37},fragile]{Launch applications}
 \begin{block}{Command}
\begin{minted}[]{bash}
...
\begin{frame}[label={sec:org3407ea0}]{More about your shell}
\begin{itemize}
...
\label{sec:org64470f2}
\begin{frame}[label={sec:org7827711},fragile]{Outline\footnote{\url{https://www.python-course.eu/python3\_course.php}}}
 \begin{itemize}
...
\begin{frame}[label={sec:org25f8597},fragile]{Installation/Setup}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc47b1c5},fragile]{Python interactive shell}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org2e62327},fragile]{Python scripts}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:orgca4e72b},fragile]{Common types and operations}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:org777a569},fragile]{Common types and operations contd.}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:orgaa09a05},fragile]{Some more operations}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:org8891fcd},fragile]{Practice}
...
\begin{frame}[label={sec:orga55af9f},fragile]{Sequential types}
 \begin{itemize}
...
\begin{frame}[label={sec:org1f49103},fragile]{Lists}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org5654842},fragile]{Examples of lists}
 \begin{center}
\begin{tabular}{ll}
\toprule
List & Description\\
...
\begin{frame}[label={sec:orgfbeaea3},fragile]{Operations on lists}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:org3773606},fragile]{Additional operations on lists}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1c7d716},fragile]{Activity}
 \note{:B\_note:
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orgb531d81},fragile]{Tuples (very briefly)}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org570b68b},fragile]{Copies of lists}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:orgb881b6b},fragile]{Numerical lists}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org41f18df},fragile]{Practice}
 \begin{block}{Please attempt}
\texttt{03\_lists\_tuples\_and\_sets.ipynb}
\end{block}
\end{frame}

\begin{frame}[label={sec:org8ae21fe},fragile]{Dictionaries}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:orga4cc9aa},fragile]{Operations on dictionaries}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb0012f4},fragile]{Conditional statements}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1ce6a8b},fragile]{Conditional assignments}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org45b8520},fragile]{Practice}
 \begin{block}{Please attempt}
\texttt{04\_if\_statements.ipynb}
\end{block}
\end{frame}

\begin{frame}[label={sec:orgf8cd306},fragile]{Loops in \texttt{Python}}
 \begin{itemize}
...
\begin{frame}[label={sec:orgd2fecaf},fragile]{The \texttt{while} loop \footnote{Picture credits:\href{https://www.python-course.eu/python3\_loops.php}{ Python Course}\label{org5f907a1}}}
 \begin{columns}
...
\begin{frame}[label={sec:orgd613240},fragile]{The \texttt{while-else} loop?}
 \begin{columns}
\begin{column}{0.48\columnwidth}
\scriptsize
\begin{minted}[]{python}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orgbb3bfbc},fragile]{\texttt{break} statement}
 \begin{columns}
\begin{column}{0.48\columnwidth}
\scriptsize
\begin{minted}[]{python}
...
\begin{frame}[label={sec:org69377d2},fragile]{\texttt{break} statement contd}
 \begin{columns}
\begin{column}{0.48\columnwidth}
\scriptsize
\begin{minted}[]{python}
...
\begin{frame}[label={sec:orgfcf3c76},fragile]{\texttt{for} loops}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org272de6e},fragile]{Activity}
 \note{:B\_note:
}
...
\end{frame}
\begin{frame}[label={sec:org7bab0c4},fragile]{\texttt{continue} statement}
 \begin{itemize}
...
\begin{frame}[label={sec:org75625b7},fragile]{\texttt{continue} statement contd.}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf000d7c},fragile]{Practice}
 \begin{block}{Please attempt}
...
\begin{frame}[label={sec:orgcf3a211},fragile]{Towards functions}
 \begin{itemize}
...
\begin{frame}[label={sec:orga62c51b},fragile]{Quick detour: How to format output?}
 \begin{itemize}
\item Always use the \texttt{format()} method for formatting strings
\item Positional or keyword params \textsuperscript{\cref{org5f907a1}}
\end{itemize}
\begin{center}
...
\begin{frame}[label={sec:orgba4478e}]{Functions}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd157b5d},fragile]{Skeleton of a function}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgcf42339},fragile]{Practice}
 \begin{block}{Please attempt}
\texttt{07\_introduction\_to\_functions.ipynb}
\texttt{08\_some\_more\_functions.ipynb}
\end{block}
\end{frame}
\begin{frame}[label={sec:org40ae8f7},fragile]{Call by value/reference \#1?}
...
\footnotesize
\begin{verbatim}
First call 4482568432 with value 3.14159
x = 3.14159  id = 4482568432
x = 42.0  id = 4483538544
Second call 4482568432 with value 3.14159
\end{verbatim}
\end{block}
\end{frame}
\begin{frame}[label={sec:org2bb8c4c},fragile]{Call by value/reference \#2?}
 What's the output of the following code block?
\footnotesize
\begin{minted}[]{python}
def side_effects(x):
...
\scriptsize
\begin{verbatim}
First call 4393677280 with value ['cs', 'mechse', 'matse']
x = ['cs', 'mechse', 'matse']  id = 4393677280
x = ['cs', 'mechse', 'matse', 'aero', 'civil']  id = 4395912080
Second call 4393677280 with value ['cs', 'mechse', 'matse']
\end{verbatim}
\end{block}
\end{frame}
\begin{frame}[label={sec:orge1bb258},fragile]{Call by value/reference \#3?}
 What's the output of the following code block?
\footnotesize
\begin{minted}[]{python}
def side_effects(x):
...
\scriptsize
\begin{verbatim}
First call 4538241504 with value ['cs', 'mechse', 'matse']
x = ['cs', 'mechse', 'matse']  id = 4538241504
x = ['cs', 'mechse', 'matse', 'aero', 'civil']  id = 4538241504
Second call 4538241504 with value ['cs', 'mechse', 'matse', 'aero', 'civil']
\end{verbatim}
\end{block}
\end{frame}
\begin{frame}[label={sec:orgd7e4856}]{Call by value/reference}
\begin{alertblock}{Take-away}
Only mutable structures can be changed with in-place transformations!
\end{alertblock}
\end{frame}

\begin{frame}[label={sec:orgbaedecb}]{Recursive functions}
\note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:orgb8bea4d},fragile]{Factorial done recursively}
 \begin{equation*}
 n! = n \times (n-1) \times (n-2) \times \cdots \times 1
\end{equation*}
...
\begin{frame}[label={sec:orgd028017},fragile]{Factorial done iteratively}
 \begin{equation*}
 n! = n \times (n-1) \times (n-2) \times \cdots \times 1
\end{equation*}
...
\begin{frame}[label={sec:org6951b0f}]{Which one is preferable?}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4e488be},fragile]{Towers of Hanoi}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org0a898c2}]{Solution strategy \footnote{\href{https://www.cs.sfu.ca/\~tamaras/recursion/Rules\_Towers\_Hanoi.html}{Computing Science - Simon Fraser University}}}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org0c1107f},fragile]{Towers of Hanoi}
 \footnotesize
\begin{minted}[]{python}
...
\begin{frame}[label={sec:orgd61db4f},fragile]{Basic I/O}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org3c3ce17},fragile]{Basic I/O continued}
 \begin{itemize}
...
\begin{frame}[label={sec:orgdc05073},fragile]{Basic I/O continued}
 \begin{itemize}
...
\begin{frame}[label={sec:orge22d172},fragile]{Basic I/O continued}
 \begin{itemize}
...
\begin{frame}[label={sec:org4f1e4f8},fragile]{Counting Words}
 \begin{block}{Activity}
...
\begin{frame}[label={sec:org89dc309},fragile]{Classes : Object oriented programming}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org9a207cf},fragile]{Classes : Object oriented programming}
 We have come a full circle! All variables (ints, floats, sequences) are
classes in \texttt{Python}!!!
\end{frame}
\begin{frame}[label={sec:orgccac213},fragile]{Modules}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:orge4d0602},fragile]{Packages}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org86f6456},fragile]{Why do we need numpy/ scipy/ matplotlib?}
 \begin{itemize}
...
\item The scientific computing eco-system in \texttt{Python} \textsuperscript{\cref{org5f907a1}}
\end{itemize}
\begin{center}
