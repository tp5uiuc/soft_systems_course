...
\begin{frame}[label={sec:org5bdc8bc}]{Logistics}
\begin{itemize}
\item Office hours
...
\label{sec:org2ef7af3}
\begin{frame}[label={sec:orgf6475cb}]{Last class}
\begin{columns}
...
\begin{frame}[label={sec:orgc78d6fb},fragile]{Content}
 \begin{itemize}
...
\begin{frame}[label={sec:org97834f3},fragile]{Quick survey}
 \begin{itemize}
\item \texttt{Python}?
...
\begin{frame}[label={sec:orgedbf8fd},fragile]{Comp. modeling with HPC using FOSS packages}
...
\begin{frame}[label={sec:org9d8ed5e},fragile]{Navigate to another directory}
 \begin{block}{Command}
\begin{minted}[]{shell}
...
\begin{frame}[label={sec:org87aff50},fragile]{Launch applications}
 \begin{block}{Command}
\begin{minted}[]{bash}
...
\begin{frame}[label={sec:org3d2f82a}]{More about your shell}
\begin{itemize}
...
\begin{frame}[label={sec:orgcfd0679},fragile]{Python interactive shell}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org9500caf},fragile]{Python scripts}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:orgcf664c9},fragile]{Common types and operations}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:orge58b540},fragile]{Common types and operations contd.}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:org6c58c5e},fragile]{Some more operations}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:org7fa1041},fragile]{Practice}
...
\begin{frame}[label={sec:orgbb7455b},fragile]{Sequential types}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc8288b0},fragile]{Lists}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6fa02ee},fragile]{Examples of lists}
 \begin{center}
\begin{tabular}{ll}
\toprule
List & Description\\
...
\begin{frame}[label={sec:orge46ebcd},fragile]{Operations on lists}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:orgbcce678},fragile]{Additional operations on lists}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4252e1e},fragile]{Activity}
 \note{:B\_note:
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orged5fe02},fragile]{Tuples (very briefly)}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7e18809},fragile]{Copies of lists}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:orgb400067},fragile]{Numerical lists}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org199b395},fragile]{Practice}
 \begin{block}{Please attempt}
\texttt{03\_lists\_tuples\_and\_sets.ipynb}
\end{block}
\end{frame}

\begin{frame}[label={sec:org241c316},fragile]{Dictionaries}
 \note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:orgb7fa583},fragile]{Operations on dictionaries}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgda0ef8c},fragile]{Conditional statements}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf363f00},fragile]{Conditional assignments}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org15482bd},fragile]{Practice}
 \begin{block}{Please attempt}
\texttt{04\_if\_statements.ipynb}
\end{block}
\end{frame}

\begin{frame}[label={sec:orgb7baef6},fragile]{Loops in \texttt{Python}}
 \begin{itemize}
...
\begin{frame}[label={sec:org832c1af},fragile]{The \texttt{while} loop \footnote{Picture credits:\href{https://www.python-course.eu/python3\_loops.php}{ Python Course}\label{org11b212d}}}
 \begin{columns}
...
\begin{frame}[label={sec:orga33cd90},fragile]{\texttt{for} loops}
 \note{:B\_note:
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgbdaa18c},fragile]{Activity}
 \note{:B\_note:
}
...
\end{frame}
\begin{frame}[label={sec:org00f0a04},fragile]{\texttt{continue} statement}
 \begin{itemize}
...
\begin{frame}[label={sec:org3f57810},fragile]{\texttt{continue} statement contd.}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc17be87},fragile]{Practice}
 \begin{block}{Please attempt}
...
\begin{frame}[label={sec:orgfc23edc},fragile]{Towards functions}
 \begin{itemize}
...
\begin{frame}[label={sec:org4d03f4e}]{Functions}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org245499b},fragile]{Skeleton of a function}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org53a84d2},fragile]{Practice}
 \begin{block}{Please attempt}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga52d665}]{Call by value/reference}
\begin{alertblock}{Take-away}
Only mutable structures can be changed with in-place transformations!
\end{alertblock}
\end{frame}

\begin{frame}[label={sec:org8ca5aac}]{Recursive functions}
\note{:B\_note:
\begin{itemize}
...
\begin{frame}[label={sec:org84c245a},fragile]{Factorial done recursively}
 \begin{equation*}
 n! = n \times (n-1) \times (n-2) \times \cdots \times 1
\end{equation*}
...
\begin{frame}[label={sec:orgb0b6667},fragile]{Factorial done iteratively}
 \begin{equation*}
 n! = n \times (n-1) \times (n-2) \times \cdots \times 1
\end{equation*}
...
\begin{frame}[label={sec:orge8446bc}]{Which one is preferable?}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgca12f23},fragile]{Towers of Hanoi}
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgb886e36}]{Solution strategy \footnote{\href{https://www.cs.sfu.ca/\~tamaras/recursion/Rules\_Towers\_Hanoi.html}{Computing Science - Simon Fraser University}}}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{itemize}
...
\begin{frame}[label={sec:org42e99e2},fragile]{Towers of Hanoi}
 \footnotesize
\begin{minted}[]{python}
...
\begin{frame}[label={sec:orgee64cf6},fragile]{Basic I/O}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga6cfc16},fragile]{Basic I/O continued}
 \begin{itemize}
...
\begin{frame}[label={sec:orgfaacb98},fragile]{Basic I/O continued}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf5204a3},fragile]{Basic I/O continued}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc2b909a},fragile]{Counting Words}
 \begin{block}{Activity}
...
\begin{frame}[label={sec:orgb7d0385},fragile]{Classes : Object oriented programming}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd203243},fragile]{Classes : Object oriented programming}
 We have come a full circle! All variables (ints, floats, sequences) are
classes in \texttt{Python}!!!
\end{frame}
\begin{frame}[label={sec:orgd8a9a80},fragile]{Modules}
 \note{:B\_note:
\begin{itemize}
