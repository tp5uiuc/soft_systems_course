...
** Python as a language
   ...
   - Open source packages[fn:2] (214,413 as of January 23, 2020)
...
** Your favorite applications use Python!
...
** Installation/Setup
	...
	- Try and perform the OS agnostic steps in the install instructions first,
      for the purposes of learning Python in today's lecture.
	- If you still can't get it setup, use a cloud-based REPL (~repl.it, onlinegdb.com~)
...
***                                                                  :B_note:
  ...
  - EXERCISE : ::inexact arithmetic--Python: 0.1+0.2 = 0.3? Show matlab
  - Python 3: 1/3 = 0.3333. Switch to Python2 gotcha. Show that 1/3 is 0;
  - Addition of strings "hello" + "wprld"
  - EXERCISE : given x, find 4.3 x**4 - 3.2x**3 + 2.1x**2 - 1.0x + 10.0
***                                                         :B_ignoreheading:
	:PROPERTIES:
	:BEAMER_env: ignoreheading
	:END:
...
** Basic I/O continued
   - Later on we will see how to store matrices and arrays using the ~loadtxt~
