...
\label{sec:org40d8e17}
\begin{frame}[label={sec:orga10f54a},fragile]{Additional packages}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd75c60a}]{Quick review}
...
\label{sec:orgee034ca}
\begin{frame}[label={sec:org4918055}]{The algorithm}
\end{frame}
\begin{frame}[label={sec:orgc7af781}]{Starting CMAes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgbfaa6c6}]{Starting CMAes: more on problem dependent parameters}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org5f2fb76},fragile]{First step : Sampling}
...
\end{frame}
\begin{frame}[label={sec:orgca98b9e},fragile]{Sampling : Python}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org58368d8}]{Covariance Matrix \footnote{\href{https://www.slideshare.net/OsamaSalaheldin2/cmaes-presentation}{CMAes overview, Slideshare}}}
\includegraphics[page=68,width=1.0\textwidth]{images/cma_slideshare.pdf}
\end{frame}
\begin{frame}[label={sec:org27d17cb}]{Covariance Matrix : Example 1}
\includegraphics[page=69,width=1.0\textwidth]{images/cma_slideshare.pdf}
\end{frame}
\begin{frame}[label={sec:org5bbcbdd}]{Covariance Matrix : Example 2}
\includegraphics[page=70,width=1.0\textwidth]{images/cma_slideshare.pdf}
\end{frame}
\begin{frame}[label={sec:org5879aaa}]{Covariance Matrix : Example 3}
\includegraphics[page=71,width=1.0\textwidth]{images/cma_slideshare.pdf}
\end{frame}
\begin{frame}[label={sec:org32b69a6}]{Covariance Matrix : Example 4}
\includegraphics[page=72,width=1.0\textwidth]{images/cma_slideshare.pdf}
\end{frame}
\begin{frame}[label={sec:orgb7a8a33}]{Covariance Matrix : Example 5}
\includegraphics[page=73,width=1.0\textwidth]{images/cma_slideshare.pdf}
\end{frame}
\begin{frame}[label={sec:orga02012d}]{Covariance Matrix : Definition}
\includegraphics[page=74,width=1.0\textwidth]{images/cma_slideshare.pdf}
\end{frame}
\begin{frame}[label={sec:orga493b04}]{Covariance Matrix : Definition}
\includegraphics[page=75,width=1.0\textwidth]{images/cma_slideshare.pdf}
\end{frame}
\begin{frame}[label={sec:orge266f45}]{Covariance Matrix : Example}
\includegraphics[page=76,width=1.0\textwidth]{images/cma_slideshare.pdf}
\end{frame}
\begin{frame}[label={sec:orgbd0562c}]{Covariance Matrix : Definition}
\includegraphics[page=77,width=1.0\textwidth]{images/cma_slideshare.pdf}
\end{frame}
\begin{frame}[label={sec:orgd37fb6f}]{Covariance Matrix : Example}
\includegraphics[page=78,width=1.0\textwidth]{images/cma_slideshare.pdf}
\end{frame}
\begin{frame}[label={sec:org6f87fea},fragile]{Sampling : Python--Answers}
 \begin{itemize}
\item What is \(\bv{C}\) / \texttt{cov} (in a 2D case) and its meaning?
\begin{enumerate}
...
\begin{frame}[label={sec:org36d4dd2}]{PCA}
\begin{block}{CMAes performs PCA on the optimzation data}
\end{block}
\begin{block}{PCA?}
\begin{enumerate}
...
\item Gives basis (in this case for \(\bv{C}\) )
\end{enumerate}
\end{block}
\end{frame}
\begin{frame}[label={sec:org176aa2e}]{Sampling : Idea of \(\bv{C}\) \(\rightarrow\) math}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orgca6faba}]{Sampling : Idea of \(\bv{C}\) \(\rightarrow\) math--Answers}
\begin{itemize}
\item How does CMA estimate \(\bv{C}\)?
\begin{enumerate}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8292a3d}]{Sampling : Parameters}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6c1913f},fragile]{Second step : Selection}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgc44758b}]{Selection : Parameters}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga8133cf},fragile]{Third step : Recombination}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org8abb750}]{Third step : Recombination--Answers}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orgbbcf80a},fragile]{Fourth step : Step size control}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org6989f35},fragile]{Step size control: Computing/Python}
...
\begin{itemize}
\item The two-norm is widely used
\end{itemize}
\end{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orgafdfe94}]{Step size control \(\rightarrow\) math}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orgdd95fb8}]{Step size : Parameters}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgf7f9dca},fragile]{Fifth step : Covariance matrix adaptation}
...
\begin{frame}[label={sec:org2916e64}]{CMA \(\rightarrow\) math}
...
\begin{frame}[label={sec:org09a7e2f}]{CMA: Parameters}
...
\begin{frame}[label={sec:org56a2297},fragile]{Terminating CMA}
...
\begin{frame}[label={sec:org0a9d96e},fragile]{Terminating CMA contd.}
 \begin{block}{Problem independent}
\begin{itemize}
...
\begin{frame}[label={sec:org3d7de0d}]{Boundaries/Constraints in CMA : Best solution strictly inside}
\begin{itemize}
...
\begin{frame}[label={sec:orgb2e5856}]{Boundaries/Constraints in CMA : Repair}
\begin{itemize}
...
\label{sec:orga965e6b}
\begin{frame}[label={sec:orgcf7103e}]{CMAes vs GA--setup}
...
\begin{frame}[label={sec:org33fcf3a}]{CMAes vs GA--setup}
\begin{itemize}
...
\begin{frame}[label={sec:org0344cb7}]{Comparison between functions\footnote{\href{http://blog.otoro.net/2017/10/29/visual-evolution-strategies/}{Otoro}}}
\begin{columns}
...
\end{frame}
\begin{frame}[label={sec:org62ffef5}]{Simple ES}
\begin{block}{Scheme}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8ddb5ac}]{Simple ES-Observations}
...
\begin{frame}[label={sec:orgba71f5c}]{Simple ES-Observations}
\begin{block}{Convergence}
\begin{itemize}
\item What do you expect for general problems?
...
\begin{frame}[label={sec:orgfd07b96}]{Simple GA}
\begin{block}{Scheme}
\begin{itemize}
...
\begin{frame}[label={sec:orgbf03b43}]{Simple GA-Observations}
\begin{block}{Convergence}
\begin{itemize}
\item What do you expect for general problems?
\item
...
\begin{frame}[label={sec:orgb817020}]{Simple GA-Observations}
\begin{block}{Convergence}
\begin{itemize}
\item What do you expect for general problems?
...
\begin{frame}[label={sec:orgef4bb6b}]{CMAes-Observations}
...
\begin{frame}[label={sec:orgd2a9bad}]{CMAes-Observations}
\begin{block}{Convergence}
\begin{itemize}
\item What do you expect for general problems?
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9c3da6b}]{CMAes-Some interesting videos}
\begin{itemize}
...
\item Knifwfisj : \url{https://www.youtube.com/watch?v=3XjgZbs0t2g}
