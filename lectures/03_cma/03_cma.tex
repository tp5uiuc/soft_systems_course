...
\label{sec:org5ade257}
\begin{frame}[label={sec:orgd571dfa},fragile]{Additional packages}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1179fdd}]{Quick review}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org449bf96}]{Starting CMAes: more on problem dependent parameters}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga970c1d},fragile]{First step : Sampling}
...
\end{frame}
\begin{frame}[label={sec:orgb185f1e},fragile]{Sampling : Python}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orga8e5c61}]{Covariance Matrix : Definition}
 ...
 % \begin{equation}
 % % \begin{pmatrix}
 % % \tikzmark{diag1}{1} & \tikzmark{top2}{1} & 0 \\
 % % 0 & 1 & \tikzmark{bottom2}{1} \\
 % % \tikzmark{end}{1} & 0 & \tikzmark{diag2}{1}\\
 % % \end{pmatrix}

 %  \begin{bmatrix}
 % 	 \tikzmark{diag1}{x} & \tikzmark{top1}{\cdot} & \tikzmark{top2}{\cdot} \\
 % 	 \tikzmark{bottom1}{\cdot}& x & \tikzmark{top3}{\cdot} \\
 % 	 \tikzmark{bottom2}{\cdot} & \tikzmark{bottom3}{\cdot} & \tikzmark{diag2}{x}\\
 %  \end{bmatrix}
 % \end{equation}
 ...
 \begin{tikzpicture}[overlay,remember picture]
	...
	in
	(\p3) -- (\p4)-- (\p5) -- (\p6) -- cycle;
%\draw[opacity=.4,line width=3mm,line cap=round] (top1.center) -- (top2.center) -- (top3.center) -- cycle;
%\draw[opacity=.4,line width=3mm,line cap=round] (bottom1.center) -- (bottom2.center) -- (bottom3.center) -- cycle;
%\draw[opacity=.4,line width=3mm,line cap=round] (diag1.center) -- (diag2.center);
 \end{tikzpicture}
\end{frame}
\begin{frame}[label={sec:org10cfefb}]{Covariance Matrix : Definition}
\includegraphics[page=75,width=1.0\textwidth]{images/cma_slideshare.pdf}
\end{frame}
\begin{frame}[label={sec:org8364111}]{Covariance Matrix : Example}
...
\begin{frame}[label={sec:org5f3227b}]{Sampling : Idea of \(\bv{C}\) \(\rightarrow\) math}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orgea4fd6d}]{Sampling : Idea of \(\bv{C}\) \(\rightarrow\) math--Answers}
\begin{itemize}
\item How does CMA estimate \(\bv{C}\)?
\begin{enumerate}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org61e2f78}]{PCA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org12f9177}]{Sampling : Parameters}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org98fa7bc},fragile]{Second step : Selection}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org92bebf3}]{Selection : Parameters}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org571352c},fragile]{Third step : Recombination}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orge148790}]{Third step : Recombination--Answers}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org3b0cfc7},fragile]{Fourth step : Step size control}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orgf6e5fb9},fragile]{Step size control: Computing/Python}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org2682d84}]{Step size control \(\rightarrow\) math}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org4715050}]{Step size : Parameters}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgef43205},fragile]{Fifth step : Covariance matrix adaptation}
...
\begin{frame}[label={sec:org9104187}]{CMA \(\rightarrow\) math}
...
\begin{frame}[label={sec:org4969c8e}]{CMA: Parameters}
...
\begin{frame}[label={sec:org10424ed},fragile]{Terminating CMA}
...
\begin{frame}[label={sec:org1173323},fragile]{Terminating CMA contd.}
 \begin{block}{Problem independent}
\begin{itemize}
...
\begin{frame}[label={sec:org6c67585}]{Boundaries/Constraints in CMA : Best solution strictly inside}
\begin{itemize}
...
\begin{frame}[label={sec:org201d9f5}]{Comparison between functions\footnote{\href{http://blog.otoro.net/2017/10/29/visual-evolution-strategies/}{Otoro}}}
\begin{columns}
...
\end{frame}
\begin{frame}[label={sec:org7418a20}]{Simple ES}
\begin{block}{Scheme}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org3d7098d}]{Simple ES-Observations}
...
\begin{frame}[label={sec:org92e19b4}]{Simple ES-Observations}
\begin{block}{Convergence}
\begin{itemize}
\item What do you expect for general problems?
...
\begin{frame}[label={sec:org38b4aba}]{Simple GA}
\begin{block}{Scheme}
\begin{itemize}
...
\begin{frame}[label={sec:org52f8fa7}]{Simple GA-Observations}
\begin{block}{Convergence}
\begin{itemize}
\item What do you expect for general problems?
\item
...
\begin{frame}[label={sec:org10b9535}]{Simple GA-Observations}
\begin{block}{Convergence}
\begin{itemize}
\item What do you expect for general problems?
...
\begin{frame}[label={sec:org5ae4f14}]{CMAes-Observations}
...
\begin{frame}[label={sec:org09c26b0}]{CMAes-Observations}
\begin{block}{Convergence}
\begin{itemize}
\item What do you expect for general problems?
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org54a85e9}]{CMAes-Some interesting videos}
\begin{itemize}
