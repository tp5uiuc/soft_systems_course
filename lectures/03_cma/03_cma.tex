...
\label{sec:org19db061}
\begin{frame}[label={sec:org5dbc9b0},fragile]{Additional packages}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org363c837}]{Quick review}
...
\begin{frame}[label={sec:org7fbe629}]{The algorithm contd..}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge366858}]{Starting CMAes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgfe676d9}]{Starting CMAes: more on problem dependent parameters}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org2a1cd91},fragile]{First step : Sampling}
...
\end{frame}
\begin{frame}[label={sec:orgc41bdfd},fragile]{Sampling : Python}
...
\begin{frame}[label={sec:org4ac1318}]{Variance}
...
\end{example}
\end{frame}
\begin{frame}[label={sec:orgba55c91}]{Covariance}
...
\begin{frame}[label={sec:orgb5415c2}]{Covariance}
...
\end{example}
\end{frame}
\begin{frame}[label={sec:org2a2d065}]{Covariance Matrix : Definition}
Covariance Matrix decides the ``direction'' of the population\ldots{}
...
\begin{frame}[label={sec:org269c04c},fragile]{Sampling : Python--Answers}
 \begin{itemize}
\item What is \(\bv{C}\) / \texttt{cov} (in a 2D case) and its meaning?
\begin{enumerate}
...
\begin{frame}[label={sec:org2d1b2bc}]{Sampling : Idea of \(\bv{C}\) \(\rightarrow\) math}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orgff54d28}]{Sampling : Idea of \(\bv{C}\) \(\rightarrow\) math--Answers}
\begin{itemize}
\item How does CMA estimate \(\bv{C}\)?
\begin{enumerate}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf06c39e}]{PCA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org16dd4da}]{Sampling : Parameters}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgbb6931f},fragile]{Second step : Selection}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge1ae225}]{Selection : Parameters}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgc32da85},fragile]{Third step : Recombination}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orgeaceecc}]{Third step : Recombination--Answers}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org34b433d},fragile]{Fourth step : Step size control}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org385573d},fragile]{Step size control: Computing/Python}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org59538a2}]{Step size control \(\rightarrow\) math}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org9fd1e0a}]{Step size : Parameters}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org3ed99f8},fragile]{Fifth step : Covariance matrix adaptation}
...
\begin{frame}[label={sec:org0a39bf7}]{CMA \(\rightarrow\) math}
...
\begin{frame}[label={sec:orge8c793f}]{CMA: Parameters}
...
\begin{frame}[label={sec:org9dfd0bf},fragile]{Terminating CMA}
...
\begin{frame}[label={sec:org559c877},fragile]{Terminating CMA contd.}
 \begin{block}{Problem independent}
\begin{itemize}
...
\begin{frame}[label={sec:org0e5f98e}]{Boundaries/Constraints in CMA : Best solution strictly inside}
\begin{itemize}
...
\begin{frame}[label={sec:org89c22b1}]{Comparison between functions\footnote{\href{http://blog.otoro.net/2017/10/29/visual-evolution-strategies/}{Otoro}}}
\begin{columns}
...
\end{frame}
\begin{frame}[label={sec:org769902d}]{Simple ES}
\begin{block}{Scheme}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9c06767}]{Simple ES-Observations}
...
\begin{frame}[label={sec:org6d88d98}]{Simple ES-Observations}
\begin{block}{Convergence}
\begin{itemize}
\item What do you expect for general problems?
...
\begin{frame}[label={sec:org6163b36}]{Simple GA}
\begin{block}{Scheme}
\begin{itemize}
...
\begin{frame}[label={sec:org68566b5}]{Simple GA-Observations}
\begin{block}{Convergence}
\begin{itemize}
\item What do you expect for general problems?
\item
...
\begin{frame}[label={sec:org16d9d4b}]{Simple GA-Observations}
\begin{block}{Convergence}
\begin{itemize}
\item What do you expect for general problems?
...
\begin{frame}[label={sec:org4485627}]{CMAes-Observations}
...
\begin{frame}[label={sec:org81a7115}]{CMAes-Observations}
\begin{block}{Convergence}
\begin{itemize}
\item What do you expect for general problems?
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgf165dac}]{CMAes-Some interesting videos}
\begin{itemize}
