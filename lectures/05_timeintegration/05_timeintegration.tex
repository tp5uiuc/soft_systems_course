...
\label{sec:org4c16a52}
\begin{frame}[label={sec:orgbfc9f91}]{Motivation}
...
\begin{frame}[label={sec:org29a9461}]{Motivation}
\begin{example}[Solve the following ODE]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org494b43a}]{Introduction}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org8600314}]{Examples}
\begin{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org2d3022b}]{Introduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1cd4ed6}]{Problem statement}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org90eba33}]{Some properties of ODEs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb3d9732}]{Numerical methods: Euler's forward method}
\begin{columns}
...
\begin{frame}[label={sec:org5ae2748}]{General explicit time stepping schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org78cd234}]{Some more time stepping schemes}
With \(\dot{x} = f(x)\),
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge208d33}]{Some more time stepping schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga581350}]{Function evaluations}
\begin{itemize}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org5e3a04c}]{Convergence/ Consistency}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgbe5a632}]{Order of convergence}
...
\end{frame}
\begin{frame}[label={sec:org7586c81}]{Order of convergence : Importance}
\begin{columns}
...
\begin{frame}[label={sec:org3ab2663}]{Order of convergence : Implementation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9c3d732}]{Order of accuracy : Results}
...
\begin{frame}[label={sec:org58aa9f6}]{Order of accuracy : Results}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org1f42261}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org59ce386}]{Higher order ODEs}
...
\begin{frame}[label={sec:org0e77093}]{Conservation laws in typical higher order ODEs}
...
\begin{frame}[label={sec:org49d2dfb}]{Conversion to lower order ODE}
...
and add them up}
\end{frame}
\begin{frame}[label={sec:org553c654}]{More schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org40124b8}]{Energy-preserving/symplectic schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1dfcd22}]{Energy-preserving/symplectic schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org10be5c5}]{But why is it energy preserving?\footnote{Peter Young, \href{https://young.physics.ucsc.edu/242/leapfrog.pdf}{Course Notes:Physics 115/242}}}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org99e39f8}]{Area preserviation of Verlet and Euler algorithms}
...
\end{frame}
\begin{frame}[label={sec:org0ee9325}]{Bottomline}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orgf1aa439}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org10fbc05}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\begin{frame}[label={sec:org1e7ca1d}]{What about backward Euler?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8b49f87}]{What about Verlet ?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org27bc5fd}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org52accd5}]{Stiff ODEs}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:orgba8a01c}]{Stiff ODEs}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org3458e9a}]{Stiff ODEs}
...
\begin{frame}[label={sec:org37c46ea}]{Summary}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org0a58dde}]{Credits}
