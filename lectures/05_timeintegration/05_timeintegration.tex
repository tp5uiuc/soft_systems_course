...
\label{sec:org10a4dbc}
\begin{frame}[label={sec:org77a7336}]{Motivation}
...
\begin{frame}[label={sec:orgf9ea97f}]{Motivation}
\begin{example}[Solve the following ODE]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org183830f}]{Introduction}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orgd40eeaf}]{Examples}
\begin{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org32afc45}]{Introduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org706359f}]{Problem statement}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc65f08d}]{Numerical methods: Euler's forward method}
\begin{columns}
...
\begin{frame}[label={sec:orgde50725}]{Order of convergence : Implementation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org722d436}]{Order of accuracy : Results}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1593d93}]{Higher order ODEs}
...
\begin{frame}[label={sec:org8d22b1e}]{Conservation laws in typical higher order ODEs}
...
\begin{frame}[label={sec:orgb11b568}]{Conversion to lower order ODE}
...
and add them up}
\end{frame}
\begin{frame}[label={sec:org0d87036}]{More schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org38fb364}]{Energy-preserving/symplectic schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgea57f7e}]{Energy-preserving/symplectic schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org187d76f}]{But why is it energy preserving?\footnote{Peter Young, \href{https://young.physics.ucsc.edu/242/leapfrog.pdf}{Course Notes:Physics 115/242}}}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgd851e6a}]{Area preserviation of Verlet and Euler algorithms}
...
\end{frame}
\begin{frame}[label={sec:orga17dd04}]{Bottomline}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org621f1cb}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8c9a2e7}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org66650d5}]{Stiff ODEs}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:org174ada8}]{Stiff ODEs}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org919bc20}]{Stiff ODEs}
...
\begin{frame}[label={sec:org3ba266c}]{Summary}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org8d53476}]{Credits}
