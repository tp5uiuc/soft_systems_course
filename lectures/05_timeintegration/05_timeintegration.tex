...
\label{sec:orgbb6cb8a}
\begin{frame}[label={sec:org89c5ffb}]{Motivation}
...
\begin{frame}[label={sec:org209c50e}]{Motivation}
\begin{example}[Solve the following ODE]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge39559f}]{Introduction}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org78ee0c0}]{Examples}
\begin{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org52b0f70}]{Introduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org277bf47}]{Problem statement}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org79563ab}]{Some properties of ODEs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org9f36cad}]{Numerical methods: Euler's forward method}
\begin{columns}
...
\begin{frame}[label={sec:orgf4bcdf3}]{General explicit time stepping schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org959f813}]{Some more time stepping schemes}
With \(\dot{x} = f(x)\),
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga667de4}]{Some more time stepping schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgcc67e0c}]{Function evaluations}
\begin{itemize}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org8ca61c9}]{Convergence/ Consistency}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org91be7ae}]{Order of convergence}
...
\end{frame}
\begin{frame}[label={sec:orgb9e8801}]{Order of convergence : Importance}
\begin{columns}
...
\begin{frame}[label={sec:orga6f25a3}]{Order of convergence : Implementation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgd124a23}]{Order of accuracy : Results}
...
\begin{frame}[label={sec:org0ebd554}]{Order of accuracy : Results}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org8e11956}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org5caef2d}]{Higher order ODEs}
...
\begin{frame}[label={sec:org16ac557}]{Conservation laws in typical higher order ODEs}
...
\begin{frame}[label={sec:org90e5c65}]{Conversion to lower order ODE}
...
and add them up}
\end{frame}
\begin{frame}[label={sec:orga61c9b1}]{More schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org55cbd69}]{Energy-preserving/symplectic schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5c46e6a}]{Energy-preserving/symplectic schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org96f8d11}]{But why is it energy preserving?\footnote{Peter Young, \href{https://young.physics.ucsc.edu/242/leapfrog.pdf}{Course Notes:Physics 115/242}}}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3c5f3e0}]{Area preserviation of Verlet and Euler algorithms}
...
\end{frame}
\begin{frame}[label={sec:org970a5a1}]{Bottomline}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org529dd63}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgf140f15}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\begin{frame}[label={sec:org82ac24d}]{What about backward Euler?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgea0e871}]{What about Verlet ?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgce9017a}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org413fd35}]{Stiff ODEs}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:org2fc7159}]{Stiff ODEs}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2861456}]{Stiff ODEs}
...
\begin{frame}[label={sec:org8f6138b}]{Summary}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org23c5792}]{Credits}
