...
\label{sec:orgcd5a2bc}
\begin{frame}[label={sec:orgdef2b57}]{Motivation}
...
\begin{frame}[label={sec:org62b2343}]{Motivation}
\begin{example}[Solve the following ODE]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org82957f4}]{Introduction}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orgbbac64a}]{Examples}
\begin{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orge213728}]{Introduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1ada682}]{Problem statement}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org26088f4}]{Numerical methods: Euler's forward method}
\begin{columns}
...
\begin{frame}[label={sec:org07deef5}]{Order of convergence : Implementation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8094f94}]{Order of accuracy : Results}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga8420e1}]{Higher order ODEs}
...
\begin{frame}[label={sec:org8cd669a}]{Conservation laws in typical higher order ODEs}
...
\begin{center}
	...
	\begin{axis}%
		...
		y label style={at={(axis description cs:0.5,0.98)},anchor=north west},
		xlabel={\textcolor{metropolisorange}{$x$}},
		ylabel={\textcolor{metropolisblue}{$\dot{x}$}},
		title style={at={(0.5,1.1)},anchor=south},
		...
		\draw [thick,->] (0.4,0) arc (0:45:0.4) node [midway, right]{$t$};
	\end{axis}
	\end{tikzpicture}
\end{center}
\end{column}
...
\begin{frame}[label={sec:orgb97fd3c}]{Conversion to lower order ODE}
...
and add them up}
\end{frame}
\begin{frame}[label={sec:org5b66cc6}]{More schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgd08d477}]{Energy-preserving/symplectic schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org055f8ed}]{Energy-preserving/symplectic schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org685baa9}]{But why is it energy preserving?\footnote{Peter Young, \href{https://young.physics.ucsc.edu/242/leapfrog.pdf}{Course Notes:Physics 115/242}}}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8fd1e3a}]{Area preserviation of Verlet and Euler algorithms}
...
\end{frame}
\begin{frame}[label={sec:orgafec6e3}]{Bottomline}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org16899df}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org4a676b2}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0fe9387}]{Stiff ODEs}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:org77b151e}]{Stiff ODEs}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga858041}]{Stiff ODEs}
...
\begin{frame}[label={sec:org30377c9}]{Summary}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orga720510}]{Credits}
