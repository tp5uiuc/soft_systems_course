...
\label{sec:orgd67beb6}
\begin{frame}[label={sec:org4627edc}]{Motivation}
...
\begin{frame}[label={sec:orgf54083e}]{Motivation}
\begin{example}[Solve the following ODE]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org130e0da}]{Introduction}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org250ea7a}]{Examples}
\begin{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orge0d8f79}]{Introduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org96ba606}]{Problem statement}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf0a2967}]{Some properties of ODEs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1b0d79a}]{Numerical methods: Euler's forward method}
\begin{columns}
...
\begin{frame}[label={sec:org623d66a}]{General explicit time stepping schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4493014}]{Some more time stepping schemes}
With \(\dot{x} = f(x)\),
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org47d6c6a}]{Some more time stepping schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5c3db8e}]{Function evaluations}
\begin{itemize}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgc2de249}]{Convergence/ Consistency}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org5ca448e}]{Order of convergence}
...
\end{frame}
\begin{frame}[label={sec:orgf6b96a4}]{Order of convergence : Importance}
\begin{columns}
...
\begin{frame}[label={sec:orgc1e37c7}]{Order of convergence : Implementation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgcfc2a40}]{Order of accuracy : Results}
...
\begin{frame}[label={sec:org994e4f8}]{Order of accuracy : Results}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org19e1953}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb2293e0}]{Higher order ODEs}
...
\begin{frame}[label={sec:org31f5674}]{Conservation laws in typical higher order ODEs}
...
\begin{frame}[label={sec:org1a5fefa}]{Conversion to lower order ODE}
...
and add them up}
\end{frame}
\begin{frame}[label={sec:org2a8be1e}]{More schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgafa46e1}]{Energy-preserving/symplectic schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgbfb3917}]{Energy-preserving/symplectic schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org52d5e09}]{But why is it energy preserving?\footnote{Peter Young, \href{https://young.physics.ucsc.edu/242/leapfrog.pdf}{Course Notes:Physics 115/242}}}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3653b12}]{Area preserviation of Verlet and Euler algorithms}
...
\end{frame}
\begin{frame}[label={sec:org3e756a0}]{Bottomline}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orgba0901e}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org15fca4e}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\begin{frame}[label={sec:orgfa9c452}]{What about backward Euler?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org877b105}]{What about Verlet ?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0459be1}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org740b8b9}]{Stiff ODEs}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:org5fcd665}]{Stiff ODEs}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgfcb160a}]{Stiff ODEs}
...
\begin{frame}[label={sec:org8685075}]{Summary}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgcc752fc}]{Credits}
