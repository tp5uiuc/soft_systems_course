...
\label{sec:orgcc360b2}
\begin{frame}[label={sec:org1e0070e}]{Motivation}
...
\begin{frame}[label={sec:org4b5a5e3}]{Motivation}
\begin{example}[Solve the following ODE]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgd6f8e19}]{Introduction}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org7f1d237}]{Examples}
\begin{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org0e7196a}]{Introduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org43c4fa5}]{Problem statement}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org044700d}]{Some properties of ODEs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc75754a}]{Numerical methods: Euler's forward method}
\begin{columns}
...
\begin{frame}[label={sec:org886f15a}]{General explicit time stepping schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc9a57cc}]{Some more time stepping schemes}
With \(\dot{x} = f(x)\),
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org587264e}]{Some more time stepping schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org75dcb1b}]{Function evaluations}
\begin{itemize}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org15b0aeb}]{Convergence/ Consistency}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org2b77fee}]{Order of convergence}
...
\end{frame}
\begin{frame}[label={sec:org611c918}]{Order of convergence : Importance}
\begin{columns}
...
\begin{frame}[label={sec:org63da81c}]{Order of convergence : Implementation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org4c7156d}]{Order of accuracy : Results}
...
\begin{frame}[label={sec:orge9b1c0e}]{Order of accuracy : Results}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org87045a8}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgdf1c900}]{Higher order ODEs}
...
\begin{frame}[label={sec:orgda78089}]{Conservation laws in typical higher order ODEs}
...
\begin{frame}[label={sec:org6f9873a}]{Conversion to lower order ODE}
...
and add them up}
\end{frame}
\begin{frame}[label={sec:orgcacfb03}]{More schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2ffac24}]{Energy-preserving/symplectic schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb9dc5d3}]{Energy-preserving/symplectic schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgce240b1}]{But why is it energy preserving?\footnote{Peter Young, \href{https://young.physics.ucsc.edu/242/leapfrog.pdf}{Course Notes:Physics 115/242}}}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org264ba5d}]{Area preserviation of Verlet and Euler algorithms}
...
\end{frame}
\begin{frame}[label={sec:org053c024}]{Bottomline}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orgfb7b6fc}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgde5079c}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\begin{tikzpicture}[scale=0.45]
	...
	\draw[very thick, metropolisorange, fill=metropolisorange, fill opacity=0.3]
	...
	\draw[very thick, metropolisorange, fill=white, fill opacity=0.6]
	(axis cs: 1, 0) circle [radius=1];
	...
	\addplot [thick, metropolisorange, fill=metropolisorange,
...
\begin{frame}[label={sec:org4690ffa}]{What about backward Euler?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org75c2146}]{What about Verlet ?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb60a8f4}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org03066fc}]{Stiff ODEs}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:org8916f33}]{Stiff ODEs}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org63d1602}]{Stiff ODEs}
...
\begin{frame}[label={sec:orgf8feb46}]{Summary}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org10eea6b}]{Credits}
