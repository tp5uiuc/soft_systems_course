...
\label{sec:orgc26911d}
\begin{frame}[label={sec:orgeafbd59}]{Motivation}
...
\begin{frame}[label={sec:org37c37bc}]{Motivation}
\begin{example}[Solve the following ODE]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org23ebe7a}]{Introduction}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orgbc2aed7}]{Examples}
\begin{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org545f3d6}]{Introduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org66424b8}]{Problem statement}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0d5a411}]{Some properties of ODEs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4a40955}]{Numerical methods: Euler's forward method \footnote{Wikimedia}}
\begin{columns}
...
\begin{frame}[label={sec:orgbc3da48}]{General explicit time stepping schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgdf1d709}]{Some more time stepping schemes\footnote{Oleg Alexandrov, Public Domain, Wikimedia}}
With \(\dot{x} = f(x)\),
...
\begin{frame}[label={sec:orgc67cba5}]{Some more time stepping schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgde8f7de}]{Function evaluations}
\begin{itemize}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgd631d24}]{Convergence/ Consistency}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgdace736}]{Order of convergence}
...
\end{frame}
\begin{frame}[label={sec:org39431a5}]{Order of convergence : Importance}
\begin{columns}
...
\begin{frame}[label={sec:org4d63654}]{Order of convergence : Implementation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org88abf87}]{Order of accuracy : Results}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org421dbf1}]{Order of accuracy : Results}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org21c861d}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4273bc5}]{Higher order ODEs}
...
\begin{frame}[label={sec:orgd7cdd04}]{Conservation laws in typical higher order ODEs}
...
\begin{frame}[label={sec:orgb417ce9}]{Conversion to lower order ODE}
...
and add them up}
\end{frame}
\begin{frame}[label={sec:org3988cf1}]{More schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge5cec4e}]{Energy-preserving/symplectic schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgeb10a6f}]{Energy-preserving/symplectic schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org9d243c3}]{But why is it energy preserving?\footnote{Peter Young, \href{https://young.physics.ucsc.edu/242/leapfrog.pdf}{Course Notes:Physics 115/242}}}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2c86f63}]{Area preserviation of Verlet and Euler algorithms}
...
\end{frame}
\begin{frame}[label={sec:orgc913e23}]{Bottomline}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org9e7f253}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgba8f990}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\begin{frame}[label={sec:org85829bf}]{What about backward Euler?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0baac54}]{What about Verlet ?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org4d8a1e5}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb670d88}]{Stiff ODEs}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:org30bb564}]{Stiff ODEs}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org50f721a}]{Stiff ODEs}
...
\begin{frame}[label={sec:org341808d}]{Summary}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgc33a74f}]{Credits}
