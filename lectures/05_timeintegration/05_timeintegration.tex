...
\label{sec:orgb2d8806}
\begin{frame}[label={sec:org2f35bdf}]{Motivation}
...
\begin{frame}[label={sec:orgb92b364}]{Motivation}
\begin{example}[Solve the following ODE]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgea056cd}]{Introduction}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orge3cc753}]{Examples}
\begin{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orgf1d3af5}]{Introduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org99c5725}]{Problem statement}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4d0b2e5}]{Some properties of ODEs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgbac3259}]{Numerical methods: Euler's forward method}
\begin{columns}
...
\begin{frame}[label={sec:org0aac0b0}]{General explicit time stepping schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org598b4d1}]{Some more time stepping schemes}
With \(\dot{x} = f(x)\),
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6896541}]{Some more time stepping schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org820380f}]{Function evaluations}
\begin{itemize}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgeb53212}]{Convergence/ Consistency}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgea05aaa}]{Order of convergence}
...
\end{frame}
\begin{frame}[label={sec:org68c8340}]{Order of convergence : Importance}
\begin{columns}
...
\begin{frame}[label={sec:org06a7166}]{Order of convergence : Implementation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2b3aa65}]{Order of accuracy : Results}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orge01c47f}]{Order of accuracy : Results}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orge60e27d}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga16f179}]{Higher order ODEs}
...
\begin{frame}[label={sec:org0357590}]{Conservation laws in typical higher order ODEs}
...
\begin{frame}[label={sec:org818b8cd}]{Conversion to lower order ODE}
...
and add them up}
\end{frame}
\begin{frame}[label={sec:orga4ad8da}]{More schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org4d5f2cd}]{Energy-preserving/symplectic schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgae3d5fe}]{Energy-preserving/symplectic schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7401a0e}]{But why is it energy preserving?\footnote{Peter Young, \href{https://young.physics.ucsc.edu/242/leapfrog.pdf}{Course Notes:Physics 115/242}}}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgeb53ada}]{Area preserviation of Verlet and Euler algorithms}
...
\end{frame}
\begin{frame}[label={sec:orgcbec418}]{Bottomline}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org2b94041}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1a2d20c}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\begin{frame}[label={sec:org942b65d}]{What about backward Euler?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgcd3171e}]{What about Verlet ?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org96ae1f4}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8005873}]{Stiff ODEs}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:org5ec58bc}]{Stiff ODEs}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgfb287fa}]{Stiff ODEs}
...
\begin{frame}[label={sec:orgf98ad6a}]{Summary}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org3620479}]{Credits}
