...
\label{sec:org8ee6083}
\begin{frame}[label={sec:orgba21cf3}]{Motivation}
...
\begin{frame}[label={sec:org2b9512b}]{Motivation}
\begin{example}[Solve the following ODE]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org759df7d}]{Introduction}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org47e71de}]{Examples}
\begin{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org61ec73f}]{Introduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga9acba9}]{Problem statement}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4ecadbe}]{Some properties of ODEs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org9d2cc2d}]{Numerical methods: Euler's forward method}
\begin{columns}
...
\begin{frame}[label={sec:org939c414}]{General explicit time stepping schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd49b8f9}]{Some more time stepping schemes}
With \(\dot{x} = f(x)\),
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge0c38ce}]{Some more time stepping schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb09c1e5}]{Function evaluations}
\begin{itemize}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgc9e06f5}]{Convergence/ Consistency}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgb82f495}]{Order of convergence}
...
\end{frame}
\begin{frame}[label={sec:org7b4adfa}]{Order of convergence : Importance}
\begin{columns}
...
\begin{frame}[label={sec:org3179025}]{Order of convergence : Implementation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5604ee3}]{Order of accuracy : Results}
...
\begin{frame}[label={sec:org6305c31}]{Order of accuracy : Results}
\begin{table}[htbp]
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org9a6b01a}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org573a6b6}]{Higher order ODEs}
...
\begin{frame}[label={sec:org3c62098}]{Conservation laws in typical higher order ODEs}
...
\begin{frame}[label={sec:orgc6e94a2}]{Conversion to lower order ODE}
...
and add them up}
\end{frame}
\begin{frame}[label={sec:orgb7aba62}]{More schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga331031}]{Energy-preserving/symplectic schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org78eb543}]{Energy-preserving/symplectic schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb938780}]{But why is it energy preserving?\footnote{Peter Young, \href{https://young.physics.ucsc.edu/242/leapfrog.pdf}{Course Notes:Physics 115/242}}}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4d9a266}]{Area preserviation of Verlet and Euler algorithms}
...
\end{frame}
\begin{frame}[label={sec:org1e52277}]{Bottomline}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org8390fd9}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org95d3a43}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\begin{frame}[label={sec:orge3402db}]{What about backward Euler?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org43430d2}]{What about Verlet ?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org19979ad}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd367c6a}]{Stiff ODEs}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:org5e99bdf}]{Stiff ODEs}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgbc0c5a4}]{Stiff ODEs}
...
\begin{frame}[label={sec:org284f098}]{Summary}
\begin{table}[htbp]
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgd361671}]{Credits}
