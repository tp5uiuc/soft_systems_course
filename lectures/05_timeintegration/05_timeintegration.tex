...
\label{sec:orgc49916f}
\begin{frame}[label={sec:orgb9e22f1}]{Motivation}
...
\begin{frame}[label={sec:org51d13df}]{Motivation}
\begin{example}[Solve the following ODE]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2b92aa5}]{Introduction}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orgeb14cfd}]{Examples}
\begin{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orgca53dba}]{Introduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org2c16235}]{Problem statement}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd43368d}]{Some properties of ODEs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga8cdd6a}]{Numerical methods: Euler's forward method \footnote{Wikimedia}}
\begin{columns}
...
\begin{frame}[label={sec:org5ce3441}]{General explicit time stepping schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf29d735}]{Some more time stepping schemes\footnote{Oleg Alexandrov, Public Domain, Wikimedia}}
With \(\dot{x} = f(x)\),
...
\begin{frame}[label={sec:org3fea312}]{Some more time stepping schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9df608a}]{Function evaluations}
\begin{itemize}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgc72a14a}]{Convergence/ Consistency}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org701da57}]{Order of convergence}
...
\end{frame}
\begin{frame}[label={sec:orgfa2d0b8}]{Order of convergence : Importance}
\begin{columns}
\begin{column}{0.4\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org3425c40}]{Order of convergence : Implementation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgab91a1d}]{Order of accuracy : Results}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgd31e2c2}]{Order of accuracy : Results}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org1adab0c}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org112e068}]{Higher order ODEs \footnote{Unknown source}}
...
\begin{frame}[label={sec:orgd511f52}]{Conservation laws in typical higher order ODEs}
...
\begin{frame}[label={sec:org5e441a3}]{Conversion to lower order ODE}
...
and add them up}
\end{frame}
\begin{frame}[label={sec:orgdf04971}]{More schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgf5b8307}]{Energy-preserving/symplectic schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgc3bb21d}]{Energy-preserving/symplectic schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4310f4c}]{But why is it energy preserving?\footnote{Peter Young, \href{https://young.physics.ucsc.edu/242/leapfrog.pdf}{Course Notes:Physics 115/242}}}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orge1940c1}]{Area preserviation of Verlet and Euler algorithms}
...
\end{frame}
\begin{frame}[label={sec:orgee63b38}]{Bottomline}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org816f11e}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6de0876}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\begin{frame}[label={sec:org6c1dcc4}]{What about backward Euler?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8cef7c6}]{What about Verlet ?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb59a26b}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org956aada}]{Stiff ODEs}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:orgfbb20ec}]{Stiff ODEs}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org214498d}]{Stiff ODEs}
...
\begin{frame}[label={sec:org96a06f5}]{Summary}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org79c28c7}]{Credits}
