...
\label{sec:org9abf8f9}
\begin{frame}[label={sec:orgbfa4573}]{Motivation}
...
\begin{frame}[label={sec:org53f62ae}]{Motivation}
\begin{example}[Solve the following ODE]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6e202b0}]{Introduction}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org77aae49}]{Examples}
\begin{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:org01fbe71}]{Introduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6ec5327}]{Problem statement}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org14eb2a4}]{Some properties of ODEs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6b96c10}]{Numerical methods: Euler's forward method \footnote{Wikimedia}}
\begin{columns}
...
\begin{frame}[label={sec:orga202efc}]{General explicit time stepping schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgbccd84c}]{Some more time stepping schemes\footnote{Oleg Alexandrov, Public Domain, Wikimedia}}
With \(\dot{x} = f(x)\),
...
\begin{frame}[label={sec:org70f6463}]{Some more time stepping schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org662ddfa}]{Function evaluations}
\begin{itemize}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org05d502f}]{Convergence/ Consistency}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgdf6e574}]{Order of convergence}
...
\end{frame}
\begin{frame}[label={sec:orge064611}]{Order of convergence : Importance}
\begin{columns}
\begin{column}{0.4\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org4c25f88}]{Order of convergence : Implementation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org05bbfb6}]{Order of accuracy : Results}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org4c53c5b}]{Order of accuracy : Results}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgc04f5c3}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6a5c047}]{Higher order ODEs \footnote{Unknown source}}
...
\begin{frame}[label={sec:org607f9be}]{Conservation laws in typical higher order ODEs}
...
\begin{frame}[label={sec:orga07cd3d}]{Conversion to lower order ODE}
...
and add them up}
\end{frame}
\begin{frame}[label={sec:org709e222}]{More schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org068d767}]{Energy-preserving/symplectic schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0bdf5fc}]{Energy-preserving/symplectic schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7cca816}]{But why is it energy preserving?\footnote{Peter Young, \href{https://young.physics.ucsc.edu/242/leapfrog.pdf}{Course Notes:Physics 115/242}}}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8308da9}]{Area preserviation of Verlet and Euler algorithms}
...
\end{frame}
\begin{frame}[label={sec:org8dc0083}]{Bottomline}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org358be5d}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0bf59a6}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\begin{frame}[label={sec:org87d67d9}]{What about backward Euler?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org88ad7b4}]{What about Verlet ?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org50481e8}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgfd64b44}]{Stiff ODEs}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:org4295321}]{Stiff ODEs}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org7180ef1}]{Stiff ODEs}
...
\begin{frame}[label={sec:org4582822}]{Summary}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org96f9410}]{Credits}
