...
\label{sec:orgfb26656}
\begin{frame}[label={sec:orgc989907}]{Motivation}
...
\begin{frame}[label={sec:org74f51f9}]{Motivation}
\begin{example}[Solve the following ODE]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org977fe19}]{Introduction}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orge2555b0}]{Examples}
\begin{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orgca0a26a}]{Introduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4a15269}]{Problem statement}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org3c5ed4e}]{Some properties of ODEs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org00880ff}]{Numerical methods: Euler's forward method}
\begin{columns}
...
\begin{frame}[label={sec:orgcef3aea}]{General explicit time stepping schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga7069b9}]{Some more time stepping schemes\footnote{Oleg Alexandrov, Public Domain, Wikimedia}}
With \(\dot{x} = f(x)\),
...
\begin{frame}[label={sec:orgd2a2929}]{Some more time stepping schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org90df665}]{Function evaluations}
\begin{itemize}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org61f7a05}]{Convergence/ Consistency}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org126aa18}]{Order of convergence}
...
\end{frame}
\begin{frame}[label={sec:orge05c994}]{Order of convergence : Importance}
\begin{columns}
...
\begin{frame}[label={sec:org3def343}]{Order of convergence : Implementation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6807018}]{Order of accuracy : Results}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org7426126}]{Order of accuracy : Results}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org7b83680}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org144f34a}]{Higher order ODEs}
...
\begin{frame}[label={sec:orgcac9ab3}]{Conservation laws in typical higher order ODEs}
...
\begin{frame}[label={sec:org52f9f4e}]{Conversion to lower order ODE}
...
and add them up}
\end{frame}
\begin{frame}[label={sec:org2f79240}]{More schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org847ee4b}]{Energy-preserving/symplectic schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8c767c6}]{Energy-preserving/symplectic schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgaac263b}]{But why is it energy preserving?\footnote{Peter Young, \href{https://young.physics.ucsc.edu/242/leapfrog.pdf}{Course Notes:Physics 115/242}}}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org6f8ff26}]{Area preserviation of Verlet and Euler algorithms}
...
\end{frame}
\begin{frame}[label={sec:org76b767b}]{Bottomline}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orgbb9cad7}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0b54814}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\begin{frame}[label={sec:org7e16496}]{What about backward Euler?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga6ac0fa}]{What about Verlet ?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0e2d771}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org633767a}]{Stiff ODEs}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:orgacaf0dd}]{Stiff ODEs}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org31299f6}]{Stiff ODEs}
...
\begin{frame}[label={sec:orgd7ede04}]{Summary}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org06a99f6}]{Credits}
