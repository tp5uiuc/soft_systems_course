...
\label{sec:orgb17408d}
\begin{frame}[label={sec:org5802df7}]{Motivation}
...
\begin{frame}[label={sec:org1438c60}]{Motivation}
\begin{example}[Solve the following ODE]
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga663a2c}]{Introduction}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org9b77811}]{Examples}
\begin{itemize}
...
\end{itemize}}
\end{frame}
\begin{frame}[label={sec:orgdc3c415}]{Introduction}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org296e7d3}]{Problem statement}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgac8345e}]{Some properties of ODEs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc06ba18}]{Numerical methods: Euler's forward method \footnote{Wikimedia}}
\begin{columns}
...
\begin{frame}[label={sec:orgecc1b4b}]{General explicit time stepping schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga651f29}]{Some more time stepping schemes\footnote{Oleg Alexandrov, Public Domain, Wikimedia}}
With \(\dot{x} = f(x)\),
...
\begin{frame}[label={sec:org318f131}]{Some more time stepping schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org4fce7ab}]{Function evaluations}
\begin{itemize}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org7d77fcd}]{Convergence/ Consistency}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orge20d014}]{Order of convergence}
...
\end{frame}
\begin{frame}[label={sec:orga79400c}]{Order of convergence : Importance}
\begin{columns}
\begin{column}{0.4\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org9497ff8}]{Order of convergence : Implementation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org730955b}]{Order of accuracy : Results}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orge14b5ee}]{Order of accuracy : Results}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org771ffa0}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1f73ac1}]{Higher order ODEs}
...
\begin{frame}[label={sec:org29d21f9}]{Conservation laws in typical higher order ODEs}
...
\begin{frame}[label={sec:org0261abb}]{Conversion to lower order ODE}
...
and add them up}
\end{frame}
\begin{frame}[label={sec:org02180c2}]{More schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org57d15df}]{Energy-preserving/symplectic schemes}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0b89d58}]{Energy-preserving/symplectic schemes}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8192897}]{But why is it energy preserving?\footnote{Peter Young, \href{https://young.physics.ucsc.edu/242/leapfrog.pdf}{Course Notes:Physics 115/242}}}
\begin{itemize}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org1691344}]{Area preserviation of Verlet and Euler algorithms}
...
\end{frame}
\begin{frame}[label={sec:org0668d83}]{Bottomline}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:orgccb72db}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1739f9b}]{Why did forward Euler blow-up?}
\begin{itemize}
...
\begin{frame}[label={sec:org7c6a1c2}]{What about backward Euler?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge8f1a49}]{What about Verlet ?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org52348b8}]{Bottomline}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga0d77f8}]{Stiff ODEs}
...
\end{alertblock}
\end{frame}
\begin{frame}[label={sec:org07fe83e}]{Stiff ODEs}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org7c2cf9a}]{Stiff ODEs}
...
\begin{frame}[label={sec:orgac59a58}]{Summary}
\begin{table}[htbp]
\caption{\label{tab_sym_snake_params}
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgef76d04}]{Credits}
