...
** Numerical methods: Euler's forward method [fn:1]
*** text                                                           :B_column:
	:PROPERTIES:
	:BEAMER_env: column
	:BEAMER_COL: 0.5
...
***                                                                :B_column:
	...
	[[file:images/oscillator_spring.png]]
...
** But why is it energy preserving?[fn:5]
   - Because it preserves the are in the \( x-p \) phase space (thus the area-preserving
