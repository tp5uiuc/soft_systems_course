...
\label{sec:org723e9c4}
\begin{frame}[label={sec:orgd3ccdf2}]{Integration and differentiation of functions}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgae7c04b}]{Where are these useful?}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb5aafcb}]{Outline}
\begin{itemize}
...
\end{frame}
\section{Quadrature}
\label{sec:orgcc8ae13}
\begin{frame}[label={sec:orgc37c758}]{Interpolatory quadrature}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6965b7c}]{What do we look for in a quadrature rule?}
...
\end{frame}
\begin{frame}[label={sec:org74374dc}]{Midpoint and Trapezoidal rules}
\begin{columns}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5bd3318}]{Midpoint rule}
...
\end{frame}
\begin{frame}[label={sec:orga62ff0b}]{Trapezoidal rule}
Suppose \(x \in [a,b]\) we have with Taylor series about \(c = \frac{a +
   b}{2}\)
...
\end{frame}
\begin{frame}[label={sec:orgd2b1957},fragile]{Other quadrature rules}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7cc4941}]{How do these perform?}
\alert{DEMO}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7706eea}]{Composite rules in quadrature}
\begin{itemize}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org78a4668}]{Composition using Trapezoidal rule}
\[ \begin{aligned} I_{\text{CT}} &= h \left[ \sum_{i=1}^{n-1} f_i +
   ...
   \end{aligned}\]
\end{frame}
\begin{frame}[label={sec:org9a8b288}]{Composite rules in quadrature}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org23c883f}]{Integrand dependence}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org1985ab5}]{Stability of quadrature}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgbe557c4}]{Soft mechanics framework}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org710ffaa}]{The \(\mathcal{A}^{h}\) operator}
...
\end{frame}
\begin{frame}[label={sec:org4787369},fragile]{The \(\mathcal{A}^{h}\) operator}
...
\end{frame}
\section{Interlude}
\label{sec:org367881b}
\begin{frame}[label={sec:org60036f5}]{Some questions about the project}
\begin{enumerate}
...
\label{sec:orgb46dd20}
\begin{frame}[label={sec:org15328da}]{Derivatives}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org98dbaf4}]{Example}
...
\end{example}
\end{frame}
\begin{frame}[label={sec:orgab98d92}]{Considerations for differentiation schemes?}
...
\end{frame}
\begin{frame}[label={sec:orgf03c2d8}]{Schemes for first-order derivatives}
...
\begin{frame}[label={sec:org3947378}]{Schemes for higher-order derivatives}
...
\end{example}
\end{frame}
\begin{frame}[label={sec:org193649b}]{What do these do?}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org7440093}]{How do these perform (accuracy) ?}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org19200b6}]{Round-off errors}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5b5dddf}]{Caution!!!}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga53d41f}]{Soft mechanics framework}
...
\begin{frame}[label={sec:orga201f9a}]{The \(\Delta^{h}\) operator}
...
\end{frame}
\begin{frame}[label={sec:org010be1a},fragile]{The \(\Delta^{h}\) operator}
 Implementation using \texttt{numpy}
\begin{minted}[,fontsize=\scriptsize]{python}
import numpy as np
...
\end{minted}
\end{frame}
\begin{frame}[label={sec:org535bc1a}]{Credits}
