...
\label{sec:org948c099}
\begin{frame}[label={sec:orgcef1296}]{Motivation}
...
\begin{frame}[label={sec:orgfe68763}]{Motivation}
\begin{columns}
...
\begin{center}
	...
	\begin{axis}[
		...
		\addplot [arrows={-latex[scale=4]}, thick, color=metropolisorange] coordinates { (0,0) (2,3) };
		\addplot [arrows={-latex[scale=4]}, thick, color=metropolisblue] coordinates { (0,0) (3,-2) };
	\end{axis}
	\end{tikzpicture}
\end{center}
\end{column}
